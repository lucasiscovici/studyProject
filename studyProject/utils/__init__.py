from .util2 import getPrivateAttr,flatArray, getClassName, has_method, merge, \
					...
					T, F, getsourceP, takeInObjIfInArr, convertCamelToSnake, securerRepr, getAnnotationInit,\
					 ...
					 isPossible, isNotPossible,createFunctionFromString, numpyToCatPdSeries, changeTmpObj, changeTmpVar, get_args, get_default_args,blockPrint, enablePrint, hidePrint, setattrAndReturnSelf, indexOfMinForValueInArray, ifOneGetArr, fnRien, fnReturn
