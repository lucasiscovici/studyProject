from .util2 import getPrivateAttr,flatArray, getClassName, has_method, merge, \
					...
					T, F, getsourceP, takeInObjIfInArr, convertCamelToSnake, securerRepr, getAnnotationInit,\
					 ...
					 isPossible, isNotPossible,unNamesEscape,createFunctionFromString, numpyToCatPdSeries, changeTmpObj, changeTmpVar, get_args, get_default_args,blockPrint, enablePrint, hidePrint, setattrAndReturnSelf, indexOfMinForValueInArray, ifOneGetArr, fnRien, fnReturn, check_in_datas ,_get_and_check ,_get_and_checks ,_get_dtype_and_data ,addMethodToObj ,_get_name ,varInFn ,secureAddArgs ,removeBadArgs,importLucas
